...
size_vir=24
size_u=2
size_a=3#this is the no of configurations
size_i=2
...
print "this is the overlap matrix of my interest\n ", S2_iuju
...
print 'done 10'
'''
S2_iuuu, Cl = func_mp2.doubly_excited_overlap(overall_i, overall_u, overall_a, 7, gamma_sin, eta_sin, lambda2, lambda3)
C.append(Cl)
print "this is the overlap matrix of my interest\n ", S2_iuuu
print 'done 11'
'''
S2_uauu, Cl = func_mp2.doubly_excited_overlap(overall_i, overall_u, overall_a, 8, gamma_sin, eta_sin, lambda2, lambda3)
C.append(Cl)
print 'done 12'
